				...
				<s:form action="updateConfirmAction" method="post">
					...
					<tr>
						...
						<td><s:textfield name="userFamilyName"
								...
								fieldName="userFamilyName"
								style="color: red; font-weight: bold;" /></td>
					</tr>
					<tr>
						<td><label>名前（名）</label></td>
						<td><s:textfield name="userLastName"
								value="%{user.userLastName}" /><br> <s:fielderror
								fieldName="userLastName" style="color: red; font-weight: bold;" /></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><s:textfield name="userPostalCode"
								value="%{user.userPostalCode}" /><br> <s:fielderror
								fieldName="userPostalCode"
								style="color: red; font-weight: bold;" /></td>
					</tr>
					<tr>
						...
						</select><br> <s:fielderror fieldName="userPrefecture"
								style="color: red; font-weight: bold;" /></td>
					</tr>
					<tr>
						<td><label>住所（市区町村）</label></td>
						<td><s:textfield name="userAddress1"
								value="%{user.userAddress1}" /><br> <s:fielderror
								fieldName="userAddress1" style="color: red; font-weight: bold;" /></td>
					</tr>
					<tr>
						<td><label>住所（番地）</label></td>
						<td><s:textfield name="userAddress2"
								value="%{user.userAddress2}" /><br> <s:fielderror
								fieldName="userAddress2" style="color: red; font-weight: bold;" /></td>
					</tr>
					<tr>
						<td><label>権限</label></td>
						<td><select name="userAuthority">
								<option value="0"
									<s:if test="%{userAuthority == 0}"> selected= "selected"</s:if>>一般</option>
								<option value="1"
									<s:if test="%{userAuthority == 1}"> selected="selected"</s:if>>管理者</option>
						</select><br> <s:fielderror fieldName="userAuthority"
								style="color: red; font-weight: bold;" /></td>
					</tr>
					<tr>
